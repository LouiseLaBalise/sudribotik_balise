...
class PositionGameElements {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PositionGameElements(null);
  ...
  static datatype() {
    ...
    return 'balise_msgs/PositionGameElements';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PositionGameElements(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = PositionGameElements;
