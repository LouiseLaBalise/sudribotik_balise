...
class PositionPxWithType {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PositionPxWithType(null);
  ...
  static datatype() {
    ...
    return 'balise_msgs/PositionPxWithType';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PositionPxWithType(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = PositionPxWithType;
